...
import TheBrand from "../../../assets/images/THEBRAND.jpg";
import secoundImageOurStory from "../../../assets/images/SecoundImageOurStory.png";
      ...
      <div className="flex flex-col ">
        ...
        <div className="flex h-screen">
          <div
            className="w-1/2 h-screen relative bg-cover bg-center"
            style={{
              backgroundImage: `url(${secoundImageOurStory})`,
              backgroundSize: "55%",
              backgroundRepeat: "no-repeat",
              backgroundAttachment: "fixed",
